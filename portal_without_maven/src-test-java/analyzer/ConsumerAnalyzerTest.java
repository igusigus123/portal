...
public class ConsumerAnalyzerTest extends Base {
	...
	public void ab_TypeCredit() throws InterruptedException, IOException {
		Pair<Boolean, String> p = an.TypeCredit("consumer");
		Assert.assertTrue(p.getValue0(), p.getValue1());

	}

	@Test
	public void ba_CreditAmount() throws InterruptedException, IOException {
		Pair<Boolean, String> p = an.SliderVerify(ao.CreditAmountSliderPoint(), ao.CreditAmountSlider(),
				ao.creditAmountInput(), ao.CreditAmountMin(), ao.CreditAmountMax());
		boolean b = p.getValue0();
		Assert.assertTrue(b, p.getValue1());
...
/*
	@Test
	public void bab_checkboxSelected() throws InterruptedException {
	...
	@Test
	public void bb_InstalltmentsCount() throws InterruptedException, IOException {
		...
		Pair<Boolean, String> p = an.SliderVerify(ao.CreditInstallmentsSliderPoint(), ao.CreditInstallmentsSlider(),
				ao.CreditInstallmentsInput(), ao.CreditInstallmentsMin(), ao.CreditInstallmentsMax());
		Assert.assertTrue(p.getValue0(), p.getValue1());
	...
	@Test
	public void bc_InstalltmentsValue() throws InterruptedException, IOException {
	...
	@Test
	public void bd_relationAmountInstallments() throws InterruptedException, IOException {
		Pair<Boolean, String> p = an.relationAmountInstallments();
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}

	@Test
	public void be_verifyTooltips() {
	...
	@Test
	public void bf_submit() throws InterruptedException {
		boolean b = true;

		b = an.amountCreditCriteriaSubmit();
	...
	public void cb_backButton() {
		...
		ao.Submit().click();
		Assert.assertTrue(ao.dependents().isDisplayed(),
				"A page after click on the submit button is different than expected");
	...
	@Test
	public void cc_sourceOfIncome() {
		Pair<Boolean, String> p = an.sourceOfIncome();
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}

	@Test
	public void cd_MonthIncome() {
		Pair<Boolean, String> p = an.monthIncome();
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}

	@Test
	public void ce_legalCharges() {
		Pair<Boolean, String> p = an.legalCharges();
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}
	...
	@Test
	public void ch_dependents() {
		Pair<Boolean, String> p = an.dependents();
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}

	@Test
	public void ci_houeseholdExpenses() {
		Pair<Boolean, String> p = an.houeseholdExpenses();
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}

	@Test
	public void cj_whyAsk() {
		ao.linkWhyAsk().click();
	...
	@Test
	public void ck_count() throws InterruptedException {
		boolean b = an.count();
	...
	public void da_summaryVerifyTooltips() throws InterruptedException, IOException {
		...
		// Assert.assertTrue(ao.toHomePage().isDisplayed(), "HomePage button is not
		// displayed");

...
public class MortgageAnalyzerTestAlone extends Base {
	...
	public void cc_creditTaker() throws InterruptedException {
		Pair<Boolean, String> p = an.creditTaker("creditTakerAlone");
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}
	...
	@Test
	public void ce_MonthIncome() {
		Pair<Boolean, String> p = an.monthIncome();
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}

	@Test
	public void cf_legalCharges() {
		Pair<Boolean, String> p = an.legalCharges();
		Assert.assertTrue(p.getValue0(), p.getValue1());
	}

	@Test
	public void cg_payedInstallments() {
		Assert.assertTrue(ao.PayedInstallmentsText().isDisplayed(), "There is no text about payed installments from the report");
		com.setPayedInstallments(ao.PayedInstallmentsText().getText());
	}

	@Test
	public void ch_creditLimits() {

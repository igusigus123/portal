...
public class Page4CreditCotakerTest extends Base{
	...
	public void ab_PreviousSteps() throws InterruptedException, IOException {
		...
		se.selectByIndex(1);
		se = new Select(apo3.sourceOfIncome2());
		se.selectByIndex(2);
		...
		apo3.legalCharges2().sendKeys(prop.getProperty("legalChargesMin"));
		clearInput(apo3.dependents());
		apo3.payedInstallments().sendKeys(Integer.toString(0));
		apo3.creditLimits().sendKeys(Integer.toString(0));
